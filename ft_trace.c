...
/*   Updated: 2017/03/20 18:35:31 by ltran            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	mlx_put_image_to_window(info->mlx, info->win, info->img, 1000, 1000);
//	mlx_pixel_put(info->mlx, info->win, x1, y1, 0X0000FFFF);
//	mlx_pixel_put(info->mlx, info->win, x2, y2, 0X0000FFFF);
	return (0);
}
