...
/*   Updated: 2017/02/25 12:16:17 by ltran            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_diagonal(int ex, int ey , int x1, int y1, int x2, int y2, void *mlx, void *win)
{
	int     i = 0;
	int		dx;
	int		dy;
...
int     ft_get_point(int x1, int x2, int y1, int y2)
{
	...
	{
		printf("Coucou EY\n");
		ft_diagonal(ex, ey, x1, y1, x2, y2, mlx, win);
	}
	else
	{
		printf("Coucou EX\n");
